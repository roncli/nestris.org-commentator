...
class Background {
     ...
     */
    static onInstalled() {
        chrome.storage.local.get(["heyNowCounter"], (result) => {
            if (result.heyNowCounter === void 0) {
                chrome.storage.local.set({heyNowCounter: 0});
            }
        });
    }
        ...
        switch (message.action) {
            case "heyNow":
                chrome.storage.local.get(["heyNowCounter"], (result) => {
                    ...
                    chrome.storage.local.set({heyNowCounter: newCount}, () => {
...
chrome.webNavigation.onHistoryStateUpdated.addListener(Background.onHistoryStateUpdated);
chrome.tabs.onRemoved.addListener(Background.onTabRemoved);
chrome.tabs.onReplaced.addListener(Background.onTabReplaced);
