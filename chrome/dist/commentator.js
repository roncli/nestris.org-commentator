                ...
                if (mutation.type === "characterData") {
                    ...
                    switch (target) {
                        case this.player1Score.firstChild:
                            chrome.runtime.sendMessage({action: "scoreChange", playerId: 0, score: +this.player1Score.innerText});
                            break;
                        case this.player2Score.firstChild:
                            chrome.runtime.sendMessage({action: "scoreChange", playerId: 1, score: +this.player2Score.innerText});
                            break;
                        case this.player1Level.firstChild:
                            chrome.runtime.sendMessage({action: "levelChange", playerId: 0, level: +this.player1Level.innerText});
                            break;
                        case this.player2Level.firstChild:
                            chrome.runtime.sendMessage({action: "levelChange", playerId: 1, level: +this.player2Level.innerText});
                            break;
                        case this.player1Lines.firstChild:
                            chrome.runtime.sendMessage({action: "linesChange", playerId: 0, lines: +this.player1Lines.innerText});
                            break;
                        case this.player2Lines.firstChild:
                            chrome.runtime.sendMessage({action: "linesChange", playerId: 1, lines: +this.player2Lines.innerText});
                            break;
                    }
                }
            }
            ...
            switch (type) {
                case "COMMENTARY":
                    ...
                    if (data.isIntroduction) {
                        ...
                        chrome.runtime.sendMessage({action: "introStarted"});
